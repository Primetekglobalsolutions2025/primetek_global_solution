...
## Based on: audits/SECURITY_AUDIT_REPORT.md

---

You are a senior application security engineer.
Your task is to fix ALL issues identified in audits/SECURITY_AUDIT_REPORT.md.
...
1. Read audits/SECURITY_AUDIT_REPORT.md completely before starting.
