...
## Based on: audits/DATABASE_AUDIT_REPORT.md

---

You are a senior database engineer and full-stack developer.
Your task is to fix ALL issues identified in audits/DATABASE_AUDIT_REPORT.md.
...
1. Read audits/DATABASE_AUDIT_REPORT.md completely before starting.
