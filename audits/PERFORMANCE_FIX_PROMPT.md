...
## Based on: audits/PERFORMANCE_AUDIT_REPORT.md

---

You are a senior performance engineer.
Your task is to fix ALL issues identified in audits/PERFORMANCE_AUDIT_REPORT.md.
...
1. Read audits/PERFORMANCE_AUDIT_REPORT.md completely before starting.
