      ...
      <div className="w-full max-w-[420px] relative z-10">
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-2">
            ...
            <span className="text-[10px] font-bold text-primary-200 uppercase tracking-[0.2em]">Secure Access</span>
          </div>
          <h1 className="text-2xl font-heading font-black text-white tracking-tight">Admin Control Center</h1>
          <p className="text-gray-400 text-xs mt-2 font-medium">Enterprise portal authentication</p>
        </div>
        ...
        <div className="mt-8 flex justify-center gap-6">
          <a href="#" className="text-[11px] font-bold text-gray-500 hover:text-primary-400 uppercase tracking-wider transition-colors">Forgot Password?</a>
          <a href="#" className="text-[11px] font-bold text-gray-500 hover:text-primary-400 uppercase tracking-wider transition-colors">Support</a>
        </div>
      </div>
    </div>
  );
